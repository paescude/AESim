...
public class Exit extends SimObject {
	...
	public Exit(Grid<Object> grid, int currentRun) throws IOException {
		...
		writer.append("\n Tick, RunNum,Week,Day,hour,Id,TriageColor,TriageNum, TypeArrival,TimeInSys, isBackInBed, patientDoctor, CurrentQueuet, timeRegist, timeTriage, timeFstAss, timeReAss, timeTest, timeXRay, IsSystem\n");
		Exit.dataNum = 0;
