	...
	public void moveBackToBed(Resource bed) {
		...
		if (doctor == null) {
			...
			System.out.println(" AFTER TESTS (or starting ReAssess inmediately) " + this.getId()
					+ " has in mind the doctor " + doctor.getId());						
			printElementsQueue(doctor.getMyPatientsInBed(),
					" my patients in bed");
...
//				System.err.println("WARNING: "+ this.getId() + " has stayed more than 10 hours, and is at: " +this.getLoc().toString()+ " time in system: "+ this.timeInSystem);
			}
		}
